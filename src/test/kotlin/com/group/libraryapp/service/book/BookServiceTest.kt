...
class BookServiceTest @Autowired constructor(
    ...
    fun loanBooktest() {
        ...
        val savedUser = userRepository.save(User("최태원", 20))

        val request = BookLoanRequest("최태원", "이상한 나라의 앨리스")
        //when
    ...
    @Test
    @DisplayName("책이 진작 대출되어 있다면, 샌규 대출이 실패한다.")
    ...
    fun returnBookTest() {
        ...
        val savedUser = userRepository.save(User("최태원", 20))
        userLoanHistoryRepository.save(UserLoanHistory.fixture(savedUser, "이상한 나라의 앨리스"))
        val request = BookReturnRequest("최태원", "이상한 나라의 앨리스")
